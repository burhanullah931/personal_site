                  ...
                  <div class="col-md-12 personal-info">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ action('Consultant\ConsultantController@update',$consultant->id ) }}" enctype="multipart/form-data" data-parsley-validate="">
                        ...
                        <div class="text-center">
                            ...
                            @else
                            <img src="{{ asset('storage/site/images/users/consultant/'.$consultant->logo) }}" width="200px" class="avatar img-circle" alt="avatar">
                            @endif
                            <h6>Upload a different photo...</h6>
                            
                            <input type="file" class="form-control @error('firstname') has-error @enderror" style="margin:auto" name="logo" required
                    ...
                    data-parsley-required-message="First name is required."
                     data-parsley-errors-container=".errorsfirstnameinput" 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="rate" name="hourly_rate" placeholder="Hourly Rate" class="form-group" value="{{$consultant->rate}}"
                            required 
                        ...
                        <div class="col-md-12">
                            <input type="text" id="linkedin" name="linkedin" placeholder="Link" value="{{$consultant->website}}" class="form-group">
                        </div>
