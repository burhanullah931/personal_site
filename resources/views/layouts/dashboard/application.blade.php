...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Consultant Directories | Dashboard</title>
   ...
   <body class="">
      ...
      <div class="wrapper ">
        @include('layouts.dashboard.includes.sidebar')
         ...
         <div class="main-panel">
            ...
            <!-- End Navbar -->
            <div class="content">
                @include('layouts.dashboard.includes.flash-message')
                @yield('content')
               <div class="content">
                    <!-- content starts -->
      ...
      <script src="{{asset('admin/dashboard/assets/js/plugins/jquery.validate.min.js')}}"></script>
      <!-- Plugin for the Wizard, full documentation here: https://github.com/VinceG/twitter-bootstrap-wizard -->
      <script src="{{asset('admin/dashboard/assets/js/plugins/jquery.bootstrap-wizard.js')}}"></script>
      ...
      <script src="{{asset('admin/dashboard/assets/js/plugins/fullcalendar.min.js')}}"></script>
      <!-- Vector Map plugin, full documentation here: http://jvectormap.com/documentation/ -->
      <script src="{{asset('admin/dashboard/assets/js/plugins/jquery-jvectormap.js')}}"></script>
      <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
      <script src="{{asset('admin/dashboard/assets/js/plugins/nouislider.min.js')}}"></script>
      <!-- Include a polyfill for ES6 Promises (optional) for IE11, UC Browser and Android browser support SweetAlert -->
      <script src="https://cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js"></script>
      <!-- Library for adding dinamically elements -->
      <script src="{{asset('admin/dashboard/assets/js/plugins/arrive.min.js')}}"></script>
      <!--  Google Maps Plugin    -->
