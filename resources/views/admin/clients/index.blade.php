                ...
                <tbody>
                  ...
                  @endphp
                    ...
                    <tr>
                        ...
                        <td>{{$client->name}}</td>
                        <td>{{$client->email}}</td> 
                        <td>@if($client->client->site)   <a href="{{ url('sites/'.$client->client->site->slug) }}" target="_blank" ><button type="button"   rel="tooltip" class="btn btn-success btn-link" data-original-title="" title=""> <i class="material-icons">remove_red_eye</i> </button></a>   @else Not Created Yet @endif</td>
