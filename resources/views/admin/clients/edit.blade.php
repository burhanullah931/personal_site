...
<div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
      <form id="RegisterValidation" action="{{action('Admin\ClientsController@update', $client->id)}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
             @csrf
             @method('PUT')
                <div class="card ">
                  ...
                  <div class="card-body ">
                      ...
                      <input type="text" class="form-control" name="firstname" id="firstname" required="true" value="{{$client->first_name}}" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group ">
                        ...
                        <input type="text" class="form-control" name="lastname" id="lastname" required="true" value="{{$client->last_name}}" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group ">
                        ...
                        <textarea rows="4" cols="50" class="form-control" name="personalsummary" id="personalsummary"  aria-required="true">{{$client->personal_summary}}</textarea>
                      ...
                      <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        <div class="fileinput-new thumbnail img-circle">
                             @isset($client->profile_pic)
                             <img src="{{asset('/storage/images/clients/'.$client->slug.'/'.$client->profile_pic)}}" alt="...">
                    ...
                    <input type="email" class="form-control" name="email" id="email" value="{{$client->email}}" required="true" disabled aria-required="true">
                      @error('email') <label id="email-error" class="error" for="email">{{$message}}</label>@enderror
                    </div>
                    <div class="form-group bmd-form-group">
                        <label for="oldpassword" class="bmd-label-floating @error('firstname') has-danger @enderror">Old Password </label>
                    ...
                    <div class="row">
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="company"  value="{{$client->company}}" name="company" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="title"  value="{{$client->title}}"   name="title" aria-required="true">
                    ...
                    <div class="form-group bmd-form-group">
                      ...
                      <input type="text" class="form-control datepicker" value="{{$client->dob}}" name="dob" id="DateOfBirth" value=""  > 
                    </div>
                    <div class="form-group bmd-form-group">
                      <label for="phone" class="bmd-label-floating"> Phone No </label>
                      <input type="text" class="form-control" name="phone" id="phone" value="{{$client->phone}}" aria-required="true">
                    </div>
                    
                    <div class="form-group bmd-form-group">
                      <label for="address" class="bmd-label-floating"> Address</label>
                      <input type="text" class="form-control"  id="address"   value="{{$client->address}}"  name="address" aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-3">
                      ...
                      <input type="text" class="form-control"  id="country"  value="{{$client->country}}"  name="country" aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-3">
                      ...
                      <input type="text" class="form-control"  id="region" value="{{$client->region}}"  name="region" aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-3">
                      ...
                      <input type="text" class="form-control"  id="city"  value="{{$client->city}}"   name="city" aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-3">
                      ...
                      <input type="text" class="form-control"  id="postalcode"  value="{{$client->postalcode}}"   name="postalcode" aria-required="true">
                  ...
                  <div class="row">
                    <div class="form-group bmd-form-group col-md-3">
                      ...
                      <input  class="form-control"  id="facebook"     name="facebook" value="{{$client->facebook}}" type='url' data-parsley-type='url'  aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-3">
                      ...
                      <input  class="form-control"  id="twitter"     name="twitter" value="{{$client->twitter}}" type='url' data-parsley-type='url'  aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-3">
                      ...
                      <input  class="form-control"  id="instagram"     name="instagram" value="{{$client->instagram}}" type='url' data-parsley-type='url'  aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-3">
                      ...
                      <input  class="form-control"  id="linkedin"     name="linkedin" value="{{$client->linkedin}}" type='url' data-parsley-type='url'  aria-required="true">
