...
<div class="container-fluid">
   <div class="row">
      <div class="col-md-12">
         <form id="RegisterValidation" action="{{route('services.store')}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
            <div class="card ">
               <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title">Template Category Form</h4>
               </div>
               <div class="card-body ">
                  <div class="form-group bmd-form-group ">
                     <label for="title" class="bmd-label-floating  @error('title') has-danger @enderror"> Title *</label>
                     <input type="text" class="form-control" name="title" id="title" required="true" aria-required="true">
                     @error('title') <label id="name-error" class="error" for="title">{{$message}}</label>@enderror
                  </div>
                  
                  <div class="form-group bmd-form-group ">
                    <label for="sub_title" class="bmd-label-floating  @error('sub_title') has-danger @enderror"> Sub Title *</label>
                    <input type="text" class="form-control" name="sub_title" id="sub_title" required="true" aria-required="true">
                    @error('sub_title') <label id="name-error" class="error" for="sub_title">{{$message}}</label>@enderror
                 </div>
                 <div class="form-group bmd-form-group ">
                  <label for="price" class="bmd-label-floating  @error('price') has-danger @enderror"> Price*</label>
                  <input type="number" min="0" class="form-control" name="price" id="price" required="true" aria-required="true">
                 ...
                 <div class="form-group bmd-form-group ">
                  ...
                  <textarea class="form-control description" name="description" id="description" required="true" aria-required="true" ></textarea>
                 ...
                 <div class="form-group bmd-form-group ">
                  ...
                  <select class="form-control selectpicker" name="service_tag[]" id="service_tag" multiple required="true" data-parsley-errors-container="#error-pages" data-style="btn btn-link">
                     <option selected hidden disabled>Select Service tags</option>
