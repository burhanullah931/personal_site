...
<div class="container-fluid">
    <div class="row">
      ...
      <div class="pull-right mb-3">
                  <a  href="{{ route('consultants.edit',$consultant->id) }}" class="btn btn-primary">Edit Consultant</a>
                  
                  <form  action="{{ route('consultants.destroy',$consultant->id) }}" class="d-inline delete-form" method="POST">
                              @csrf
                              @method('DELETE')
                            ...
                            <a href="{{ url('dashboard/consultants/activate/' . $consultant->id) }}" class="btn btn-success "  >
                              approve
                            </a>
                            @else
                            <a href="{{ url('dashboard/consultants/deactivate/' . $consultant->id) }}" class="btn btn-warning " >
                              disapprove
                            </a>@endif
                  </div>
             ...
             @method('PUT')
                <div class="card ">
                  ...
                  <div class="form-group bmd-form-group ">
                      ...
                      <input type="text" class="form-control" name="fname" id="fname" required="true" value="{{$consultant->first_name}}" aria-required="true" disabled>
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="lname" id="lname" required="true" value="{{$consultant->last_name}}" aria-required="true" disabled>
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="title"  value="{{$consultant->job_title}}"   name="title" aria-required="true" disabled>
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="company"  value="{{$consultant->organization}}"   name="company" aria-required="true" disabled>
                      ...
                      <div class="form-group bmd-form-group col-md-4">
                          <select class="selectpicker" data-style="select-with-transition" name="category_id" title="Select Category" data-size="7" disabled>
                      ...
                      <div class="form-group bmd-form-group col-md-4">
                          <select class="selectpicker" data-style="select-with-transition" name="compensation" title="Select Compensation" data-size="7" disabled>
                      ...
                      <div class="form-group bmd-form-group col-md-4">
                        ...
                        <input type="text" class="form-control"  id="hourly_rate"  value="{{$consultant->current_salary}}"   name="hourly_rate" aria-required="true" disabled>
                      ...
                      <div class="form-group bmd-form-group ">
                        ...
                        <textarea rows="4" cols="150" class="form-control" name="summary" id="summary"  aria-required="true" disabled>{{$consultant->summary}}</textarea>
                    ...
                    <select class="form-control js-example-tags"  name="skills[]" multiple="multiple" required  disabled
                    ...
                    <div class="form-group bmd-form-group col-md-6">
                      ...
                      <input type="text" class="form-control"  id="state" value="{{$consultant->region}}"  disabled name="state" aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-6">
                      ...
                      <input type="text" class="form-control"  id="country"  value="{{$consultant->country}}" disabled name="country" aria-required="true">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group bmd-form-group col-md-12">
                      ...
                      <input  class="form-control"  id="linkedin"     name="linkedin" value="{{$consultant->linkedin}}" disabled type='url' data-parsley-type='url'  aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-12">
                      ...
                      <input  class="form-control"  id="website"     name="website" value="{{$consultant->website}}" disabled type='url' data-parsley-type='url'  aria-required="true">
