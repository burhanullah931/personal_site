             ...
             @method('PUT')
                <div class="card ">
                  <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">Update Recruiter Form</h4>
                  </div>
                  <div class="card-body ">
                  ...
                  <div class="form-group bmd-form-group ">
                      ...
                      <input type="text" class="form-control" name="fname" id="fname" required="true" value="{{$recruiter->first_name}}" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="lname" id="lname" required="true" value="{{$recruiter->last_name}}" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="title"  value="{{$recruiter->job_title}}"   name="title" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="company"  value="{{$recruiter->organization}}"   name="company" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group ">
                        ...
                        <textarea rows="4" cols="150" class="form-control" name="summary" id="summary"  aria-required="true">{{$recruiter->summary}}</textarea>
                    ...
                    <div class="form-group bmd-form-group col-md-6">
                      ...
                      <input type="text" class="form-control"  id="state" value="{{$recruiter->region}}"  name="state" aria-required="true">
                    ...
                    <div class="form-group bmd-form-group col-md-6">
                      ...
                      <input type="text" class="form-control"  id="country"  value="{{$recruiter->country}}"  name="country" aria-required="true">
