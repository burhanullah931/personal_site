...
<div class="container-fluid">
    <div class="row">
      ...
      <div class="pull-right mb-3">
                  <a  href="{{ route('recruiters.edit',$recruiter->id) }}" class="btn btn-primary">Edit Recruiter</a>
                  
                  <form action="{{ route('recruiters.destroy',$recruiter->id) }}" class="d-inline delete-form" method="POST">
                              @csrf
                              @method('DELETE')
                            ...
                            @if(!$recruiter->active)
                            <a href="{{ url('dashboard/recruiters/activate/' . $recruiter->id) }}" class="btn btn-success ">
                              Approve
                            </a>
                            @else
                            <a href="{{ url('dashboard/recruiters/deactivate/' . $recruiter->id) }}" class="btn btn-warning ">
                              Disapprove</a>@endif
                  </div>
      <form id="RegisterValidation" action="{{action('Admin\RecruitersController@update', $recruiter->id)}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
             @csrf
             @method('PUT')
                <div class="card ">
                  ...
                  <div class="form-group bmd-form-group ">
                      ...
                      <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        ...
                        @if(($recruiter->logo == Null) || ($recruiter->logo == 'noimage.png'))
                            
                             <img src="{{asset('admin/dashboard/assets/img/placeholder.jpg')}}" alt="...">
                              @else
                              
                              <img src="{{asset('storage/site/images/users/recruiter/'.$recruiter->logo)}}" alt="...">
                      ...
                      <input type="text" class="form-control" name="fname" id="fname" required="true" value="{{$recruiter->first_name}}" aria-required="true" disabled>
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="lname" id="lname" required="true" value="{{$recruiter->last_name}}" aria-required="true" disabled>
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="title"  value="{{$recruiter->job_title}}"   name="title" aria-required="true" disabled>
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="company"  value="{{$recruiter->organization}}"   name="company" aria-required="true" disabled>
                      ...
                      <div class="form-group bmd-form-group ">
                        ...
                        <textarea rows="4" cols="150" class="form-control" name="summary" id="summary"  aria-required="true" disabled>{{$recruiter->summary}}</textarea>
                    ...
                    <div class="form-group bmd-form-group col-md-6">
                      ...
                      <input type="text" class="form-control"  id="state" value="{{$recruiter->region}}"  name="state" aria-required="true" disabled>
                    ...
                    <div class="form-group bmd-form-group col-md-6">
                      ...
                      <input type="text" class="form-control"  id="country"  value="{{$recruiter->country}}"  name="country" aria-required="true" disabled>
