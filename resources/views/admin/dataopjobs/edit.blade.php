             ...
             @method('PUT')
                <div class="card ">
                  <div class="card-header card-header-rose card-header-icon">
                    ...
                    <h4 class="card-title">Update job Form</h4>
                  </div>
                  <div class="card-body ">
                      ...
                      <input type="text" class="form-control" name="title" id="title" required="true" value="{{$job->job_title}}" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="employer" id="employer" required="true" value="{{$job->employer}}" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="location"  value="{{$job->location}}"   name="location" aria-required="true">
                      ...
                      <div class="form-group bmd-form-group col-md-6">
                        ...
                        <input type="text" class="form-control"  id="job_link"  value="{{$job->joblink}}"   name="job_link" aria-required="true">
                        @error('job_link') <label id="job_link-error" class="error" for="job_link">{{$message}}</label>@enderror
                      </div>
                      <div class="form-group bmd-form-group col-md-6">
                          <select class="selectpicker" data-style="select-with-transition" name="job_category_id" title="Select Job Category" data-size="7">
                      ...
                      <div class="form-group bmd-form-group " style="width:100%">
                        ...
                        <textarea  class="form-control" name="description" id="description"  aria-required="true">{{$job->description}}</textarea>
