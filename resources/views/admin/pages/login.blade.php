...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{ asset('admin/dashboard/assets/css/material-dashboard.css?v=2.1.0')}}" rel="stylesheet" />
...
<body class="off-canvas-sidebar">
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="">Personal Site | Login Page</a>
      </div>
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('{{asset('admin/dashboard/assets/img/login.jpg')}}'); background-size: cover; background-position: top center;">
            ...
            <form class="form" method="POST" action="{{ route('login') }}">
              ...
              <div class="card card-login card-hidden">
                ...
                <div class="card-body ">
                  ...
                  <p class="card-description text-center">Dashboard</p>
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="email"  email="true" required  name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email...">
                  ...
                  <span class="bmd-form-group">
                    ...
                    @error('password')
                     ...
                     @enderror
                      ...
                      {{-- <input class="form-ccontrol" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
      ...
      <footer class="footer">
        <div class="container">
          ...
          <div class="copyright float-right">
            ...
            <a href="www.personalsite.net" target="_blank">Personal Site</a> by Nausal Tech for a better web.
          </div>
        </div>
      </footer>
    </div>
  ...
  <!--   Core JS Files   -->
  <script src="{{ asset('admin/dashboard/assets/js/core/jquery.min.js')}}"></script>
