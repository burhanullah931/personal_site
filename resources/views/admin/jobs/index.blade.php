                ...
                <tbody>
                  ...
                  @endphp
                    ...
                    <tr>
                        ...
                        <td  onclick="demo.showSwal('warning-message-and-cancel')">{{$job->location}}</td> 
                        ...
                        <td class="td-actions text-right">
                          @if($job->featured)
                          <a href="{{ url('dashboard/jobs/unfeature/' . $job->id) }}" ><button type="button" rel="tooltip" class="btn btn-primary" data-original-title="" title="Feature">
                           Unfeature
                          </button></a>
                          @else
                          <a href="{{ url('dashboard/jobs/feature/' . $job->id) }}" ><button type="button" rel="tooltip" class="btn btn-warning" data-original-title="" title="Feature">
                            Feature
                           </button></a>
                          @endif
                        <a href="{{ route('jobs.show',$job->id) }}" ><button type="button" rel="tooltip" class="btn btn-info btn-link" data-original-title="" title="View">
                              <i class="material-icons">visibility</i>
                            </button></a>
                            
                            <a href="{{ route('jobs.edit',$job->id) }}" ><button type="button" rel="tooltip" class="btn btn-success btn-link" data-original-title="" title="Edit">
                              <i class="material-icons">edit</i>
                            </button></a>
                           
                           

                <form class="delete-form"   action="{{ route('jobs.destroy',$job->id) }}" class="d-inline" method="POST">
                              @csrf
                              @method('DELETE')
