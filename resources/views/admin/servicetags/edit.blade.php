...
<div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
      <form id="RegisterValidation" action="{{route('templatecategories.update', $templatecategory->id)}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
             @csrf
             @method('PUT')
                <div class="card ">
                  ...
                  <div class="card-body ">
                      ...
                      <div class="form-group bmd-form-group ">
                        <label for="name" class="bmd-label-floating  @error('name') has-danger @enderror"> Name *</label>
                      <input type="text" value="{{$templatecategory->name}}" class="form-control" name="name" id="name" required="true" aria-required="true">
                        @error('name') <label id="name-error" class="error" for="name">{{$name}}</label>@enderror
                      </div>
