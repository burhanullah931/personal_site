...
<div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
      <form id="RegisterValidation" action="{{route('maintenance.store')}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
             @csrf
                <div class="card ">
                  ...
                  <div class="card-body ">
                      ...
                      <div class="form-group bmd-form-group ">
                        ...
                        <textarea rows="4" cols="50" class="form-control" name="message" id="message"  aria-required="true"></textarea>
