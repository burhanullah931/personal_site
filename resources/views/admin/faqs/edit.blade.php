...
<div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
      <form id="RegisterValidation" action="{{action('Admin\FaqsController@update', $faq->id)}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
             @csrf
             @method('PUT')
             <div class="card ">
              ...
              <div class="form-group bmd-form-group">
                        ...
                        <option @if($faq->type == 'work') selected @endif value="work">Work</option>
                        <option @if($faq->type == 'hire') selected @endif value="hire">Hire</option>
                          </select>
                        </div>
                  
                  <div class="form-group bmd-form-group ">
                    <label for="question" class="bmd-label-floating @error('laststname') has-danger @enderror"> Question *</label>
                    <input type="text" class="form-control" name="question" id="question" required="true" value="{{$faq->question}}" aria-required="true">
                  ...
                  <div class="form-group bmd-form-group ">
                    ...
                    <textarea rows="4" cols="50" class="form-control" name="answer" id="answer" required="true"  aria-required="true">{{$faq->answer}}</textarea>
