...
<div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
      <form id="RegisterValidation" action="{{action('Admin\CategoriesController@update', $cat->id)}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
             @csrf
             @method('PUT')
                <div class="card ">
                  ...
                  <div class="card-body ">
                      ...
                      <input type="text" class="form-control" name="title" id="title" required="true" value="{{$cat->name}}" aria-required="true">
